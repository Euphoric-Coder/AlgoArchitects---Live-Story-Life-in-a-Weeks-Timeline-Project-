...
export class TimelinePDFExporter {
  ...
  addStatistics(events) {
    ...
    const statsData = [
      ...
      { label: 'Global Events', value: stats.globalEvents.toString(), color: [245, 158, 11] },
      { label: 'Historical Events', value: stats.historicalEvents.toString(), color: [245, 221, 75] }
    ];
  ...
  calculateStatistics(events) {
    ...
    return {
      ...
      historicalEvents: eventsByType.historical || 0
    };
  }
