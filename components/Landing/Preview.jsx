...
const Preview = () => {
  ...
  const timelineData = {
    ...
    2019: [
      ...
      },
      {
        ...
        description: "Lifelong friendship began",
        icon: Users,
    ...
    2021: [
      {
        ...
        description: "Completed SF Marathon",
        icon: Award,
        color: "from-amber-500 to-amber-600",
      },
      {
    ...
    2022: [
      ...
      },
      {
        ...
        description: "Started photography",
        icon: Award,
        color: "from-amber-500 to-amber-600",
      },
      {
        ...
        type: "career",
        title: "Side Project",
        description: "App reached 10K users",
        icon: Zap,
        color: "from-emerald-500 to-emerald-600",
      },
    ],
    ...
    2023: [
      {
        ...
        type: "career",
        title: "Career Change",
        description: "Joined Fortune 500",
        icon: Briefcase,
        color: "from-purple-500 to-purple-600",
      },
      {
  ...
  return (
    <section
      id="preview"
      className="py-32 px-4 bg-blue-50 dark:bg-gray-800 transition-colors duration-300 relative overflow-hidden"
    >
      {/* Background Glow */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Each block represents a week. Navigate through years and explore
            your milestones visually.
          </p>
        </div>
          ...
          <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-slate-200/50 dark:border-slate-700/50 shadow-2xl shadow-slate-200/20 dark:shadow-slate-900/20">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-12 pb-8 border-b border-slate-200/50 dark:border-slate-700/50">
              <div className="flex items-center gap-6 mb-6 lg:mb-0">
                ...
                <div>
                  <h3 className="text-2xl md:text-3xl font-semibold text-slate-800 dark:text-white mb-2">
                    Life Timeline
                  </h3>
              ...
              <div className="flex items-center gap-4">
                <button
                  onClick={() =>
                    setSelectedYear(Math.max(years[0], selectedYear - 1))
                  }
            ...
            <div className="mb-10">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {eventTypes.map((type, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-3 p-4 bg-slate-50/80 dark:bg-slate-700/50 rounded-xl border border-slate-200/30 dark:border-slate-600/30 backdrop-blur-sm"
                  >
                    <div
                      className={`w-4 h-4 bg-gradient-to-r ${type.color} rounded-lg shadow-sm`}
                    ></div>
                ...
                {Array.from({ length: 12 }, (_, monthIndex) => (
                  <div key={monthIndex} className="flex flex-col gap-2">
                    {Array.from({ length: 4 }, (_, weekInMonth) => {
                      ...
                      const event = currentYearEvents.find(
                        (e) => e.week === weekNumber,
                      );
                      const isEvent = !!event;
                            ...
                            <>
                              ...
                              <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all duration-300 z-20 pointer-events-none">
                                <div className="bg-slate-900 dark:bg-slate-700 text-white text-xs px-3 py-2 rounded-lg whitespace-nowrap shadow-xl border border-slate-700 dark:border-slate-600 backdrop-blur-sm">
                                  ...
                                  <div className="text-slate-300 dark:text-slate-400 text-xs mt-1">
                                    {event.description}
                                  </div>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div
                              className={`px-3 py-1 bg-gradient-to-r ${event.color} rounded-full`}
                            >
